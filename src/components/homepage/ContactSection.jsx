  ...
  return (
    <div id="contact" className="my-12 lg:my-16 relative mt-24 text-white">
      <div className="hidden lg:flex flex-col items-center absolute top-24 -right-8">
        <span className="bg-[#1a1a1a] w-fit text-white rotate-90 p-2 px-5 text-xl rounded-md">
          <DecryptedText text="CONTACT" animateOn="view" revealDirection="center" />
        </span>
        <span className="h-36 w-[2px] bg-[#1a1a1a]"></span>
      </div>
        ...
        <div className="lg:w-3/4">
          <div className="flex flex-col gap-5 lg:gap-9">
            <p className="text-sm md:text-xl flex items-center gap-3">
              <a href={`mailto:${personalData.email}`}>
                <MdAlternateEmail
                  className="bg-[#8b98a5] p-2 rounded-full hover:bg-zinc-400 hover:scale-110 transition-all duration-300 text-gray-800 cursor-pointer"
                  size={36}
                />
              </a>
              <a href={`mailto:${personalData.email}`} className="hover:text-zinc-300 transition-colors">
          ...
          <div className="mt-8 lg:mt-16 flex flex-wrap justify-center lg:justify-start items-center gap-3 sm:gap-5 lg:gap-10">
            <a target="_blank" rel="noopener noreferrer" href={personalData.github}>
              <IoLogoGithub
                className="bg-[#8b98a5] p-2 sm:p-3 rounded-full hover:bg-zinc-400 hover:scale-110 transition-all duration-300 text-gray-800 cursor-pointer"
                size={40}
              />
            </a>
